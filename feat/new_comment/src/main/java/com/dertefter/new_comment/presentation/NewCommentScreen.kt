...
import com.dertefter.new_comment.presentation.component.UploadCard
        ...
        topBar = {
            ...
            )
            {
                Text(
                    ...
                    text = stringResource(R.string.new_comment_title),
                )
...
@Composable
private fun NewCommentScreenPreview() {
    AppTheme {
        NewCommentScreen(
            uiState = UiState(
                content = "Hello",
